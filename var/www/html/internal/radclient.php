...
radius_put_string($radh, RADIUS_NAS_IDENTIFIER, 'Carbon XGE local');
...
function show_error($radh, $error) {
	...
	case RADIUS_ACCESS_REJECT:
		printf("RADIUS_ACCESS_REJECT: Доступ запрещён биллингом\n");
		break;
	case RADIUS_ACCESS_CHALLENGE:
		printf("RADIUS_ACCESS_CHALLENGE\n");
		break;
	case RADIUS_ACCESS_ACCEPT:
		echo("Доступ разрешён, TODO: 302 redirect\n");
